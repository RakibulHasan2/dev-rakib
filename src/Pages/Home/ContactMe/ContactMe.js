    ...
    return (
        <div className='p-16'>
            ...
            <div className='lg:flex justify-evenly p-14 mb-10 bg-gray-900'>
                ...
                <div className='rounded-lg p-8 bg-white shadow-2xl'>
                    ...
                    <form>
                        <div className='login-form '>
                            ...
                            <input type="text" className='p-2 w-80 bg-gray-300 text-black rounded-xl' name='name' id='' placeholder='Your Name' />
                        </div>
                        <br />
                        <div className='login-form  flex justify-evenly'>
                            <label htmlFor="email" className='text-xl  text-black  font-bold'>Email : </label>
                            <input type="email" className='p-2 w-80 bg-gray-300  text-black rounded-xl' name='email' id='' placeholder='Your email address' />
                        </div>
                        <br />
